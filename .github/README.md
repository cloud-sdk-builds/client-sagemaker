...
[`@aws-sdk/client-sagemaker`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker/v/3.588.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker@3.588.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zvzah+C+NCsb8usNF6FVuhDHGkcdUTcOYNVXQCXQY8Xs/dSlnDRoG+AtX2B8imzi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker@3.588.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker@3.588.0/index.min.mjs": "sha384-zvzah+C+NCsb8usNF6FVuhDHGkcdUTcOYNVXQCXQY8Xs/dSlnDRoG+AtX2B8imzi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-sagemaker/blob/refs/tags/3.588.0/LICENSE
```
